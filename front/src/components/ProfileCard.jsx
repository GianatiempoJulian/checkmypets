      ...
      <article className="bg-stone-800 m-5 h-full">
        <section className="pet-info grid grid-rows-2 justify-center items-center justify-items-center">
          ...
          <div className="flex flex-col gap-2">
            <span className="bg-stone-500 rounded-md p-1 flex gap-5">
              <svg
            ...
            <span className="bg-stone-500 rounded-md p-1 flex gap-5 text-sm">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
        ...
        <section className="medicine-status grid grid-rows-3 grid-cols-2 gap-2 m-2 mt-5"></section>
      </article>
    </>
  );
}
